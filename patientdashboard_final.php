...
<body>
  ...
  <script>
    ...
    let appointmentHistory = [
      {doctor: 'Dra. Aiane Jade Bote', date: '2025-05-18', time: '08:00 AM', status: 'done'},
  ...
  fetch('get_doctors_final.php')
    ...
    function renderAppointmentHistory() {
      ...
      fetch('get_appointment_patient.php', {
        method: 'GET',
        credentials: 'include'
      })
      .then(response => response.json())
      .then(appointments => {
      if (appointment.length === 0 || appointment.error) {
     ...
     .catch(err => {
       appointmentHistoryList.textContent = "Failed to load appointment history.";
    ...
    confirmYesBtn.addEventListener('click', () => {
      ...
      fetch('book_appointment_final.php', {
        method: 'POST',
